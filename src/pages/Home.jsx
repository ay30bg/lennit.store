...
//             <img src="https://blog.hignellrentals.com/hubfs/Imported_Blog_Media/Untitled%20design%20(1).png" alt="Electronics" />
//             <span>Appliances</span>
//           </div>
//           <div className="category-card">
//             <img src="https://media.gettyimages.com/id/1676665264/photo/cheerful-friends-laughing-against-sky.jpg?s=612x612&w=0&k=20&c=vD3scifjFv8lgEGCO4475F1m7uFpCzBmLqY-Is90BIA=" alt="Fashion" />
//             <span>Fashion</span>
//           </div>
//           <div className="category-card">
//             <img src="https://media.gettyimages.com/id/2091553646/photo/set-of-fashion-collection-with-trendy-fashion-clothes-and-make-up-cosmetic-products-for-women.jpg?s=612x612&w=0&k=20&c=EhDGoneATuFlxph0okJIE3yam2EuuM0iq5LCudehhyY=" alt="Accessories" />
//             <span>Accessories</span>
//           </div>
//           <div className="category-card">
//             <img src="https://media.gettyimages.com/id/1135086435/photo/a-serene-zero-waste-kitchen-scene-close-up.jpg?s=612x612&w=0&k=20&c=AtqHW8x7MzqGvP1sPos92BCnQzf1S54p_am0GtEQQPg=" alt="Home & Living" />
//             <span>Kitchen</span>
//           </div>
//         </div>
//       </section>
...
//       <ProductSection id="featured" title="Featured Products" products={featured} headerColor="orange" />
//       <ProductSection id="recommended" title="Recommended for You" products={recommended} headerColor="orange" />
//       <ProductSection id="deals" title="Top Deals" products={deals} headerColor="red" />
//     </div>
//   );
// }
